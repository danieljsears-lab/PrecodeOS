...
| Reader-facing docs | `docs/*.md` | Long-form human guides for philosophy, guided setup, beginner orientation, day-to-day use, Claude Code students, architecture review, and file-level navigation. |
