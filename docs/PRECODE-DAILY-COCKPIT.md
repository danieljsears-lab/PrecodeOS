...
| Review | `Review: check this work or artifact before I accept it.` | Human review guidance; route to Review Lanes, Engineering Quality Review Lane, Polish / Product-Taste Review Lane, PRD Handoff Readiness, release review, or proof tracing only when the current artifact or risk calls for it. |
