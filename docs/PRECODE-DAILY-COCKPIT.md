...
| Review | `Review: check this work or artifact before I accept it.` | Human review guidance; route to one Review Lane, Multi-Lane Review Invocation for one named target with 2-3 risks, PRD Handoff Readiness, release review, or proof tracing only when the current artifact or risk calls for it. |
