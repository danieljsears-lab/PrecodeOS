# Student Completion Evidence Packet
<!-- ANCHOR: student-completion-evidence-packet -->

> AUTHORITY: Reusable student-facing template for capturing lightweight cohort completion evidence across Discovery, Scope, Ownership, and Proof gates.
...
> LOAD_WHEN: A student, instructor, mentor, or support engineer needs a short public-safe completion snapshot for a cohort, workshop, demo, or prototype handoff.
> CLASS: reference
...
Use this packet when a student is finishing, demoing, or handing off a prototype in a guided cohort.

The packet helps the student, instructor, and support engineer see the same progress snapshot without inventing a new format. It is evidence, not authority. It does not prove the idea is validated, approve a PRD, accept implementation work, or replace student-owned product decisions.

Keep it short. Good evidence can come from normal cohort work: student checkouts, instructor notes, support unblocking notes, prototype demos, recorded checks, screenshots, or final reflections.
...
Can the student explain the problem, user, current workaround or evidence, and weakest assumption in plain language?
...
Can the student name the first useful slice and at least one explicit non-goal?

- First useful slice:
- What this version does:
- Non-goals or not-yet items:
- Scope tradeoff the student chose:

Gate status: `met | needs work | blocked`

### Gate 3: Ownership

Did instructors coach and support engineers unblock while the student owned product choices, approvals, acceptance, and risk decisions?

- Product decisions the student made:
- Approvals or acceptance calls the student made:
- Instructor help received:
- Support engineer help received:
- Risk, privacy, auth, payment, deployment, or data decisions the student owned:

Gate status: `met | needs work | blocked`

### Gate 4: Proof

Was the prototype demoed or verified, and can the student explain what evidence supports continuing, narrowing, pausing, or changing direction?
