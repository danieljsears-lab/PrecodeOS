...
PRD_CLUSTERS = (
    ...
    PrdCluster(
        ...
        purpose="Generated PRD/doctor/authority-map surfaces, package-surface structure, session-friction review, usage evidence review, and generated-output boundaries.",
        prd_ids=("PRD-007", "PRD-008", "PRD-012", "PRD-014", "PRD-027", "PRD-045", "PRD-046", "PRD-048"),
    ),
    PrdCluster(
