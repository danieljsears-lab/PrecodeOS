Create one horizontal animation strip for Codex pet `scout`, state `running-left`.
...
Identity: same pet in every frame: Compact explorer companion for Dan: curious about the world, helpful, realistic and evidence-minded, warm smile, eager to learn, practical maintainer energy. Small rounded field-guide mascot with expressive eyes, tiny explorer scarf, compact notebook and compass-like charm as non-text props. No logos, no readable text, no UI, no shadows, no detached effects.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
Style: Pet-safe sprite: compact full-body mascot, readable in a 192x208 cell, clear silhouette, simple face, stable palette/materials, and crisp edges for chroma-key extraction. Style `3d-toy`: Stylized 3D toy mascot with smooth rounded forms, simple materials, clear silhouette, and no photoreal complexity. User style notes: Readable non-pixel soft 3D toy mascot, warm neutral earth-and-sky palette, simple full-body silhouette, clean materials, stable prop design, pet-safe at 192x208..
